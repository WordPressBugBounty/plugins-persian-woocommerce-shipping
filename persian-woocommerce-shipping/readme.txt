...
## امکانات
* دارای چهار روش ارسال: پیشتاز، تیپاکس و پیک موتوری
...
* محاسبه اتوماتیک هزینه پست پیشتاز بر اساس وزن (تعرفه سال 1400)
...
* محاسبه دقیق هزینه پست پیشتاز و پست ویژه
...
* بهبود سرعت بارگذاری منوهای حمل و نقل
= 4.4.0 =
...
= 4.3.0 =
* افزودن قابلیت پس کرایه به روش‌های حمل و نقل
* نمایش ریسپانسیو نقشه در موبایل‌های مختلف
* بروزرسانی نرخ نامه پرداخت در محل تاپین
* حل مشکل عدم بروزرسانی سفارشات با تاپین
* سازگاری با ووکامرس ۱۰.۱
= 4.2.8 =
...
* بروزرسانی نرخ پست پیشتاز تاپین
* بروزرسانی نرخ بیمه و پرداخت در محل پست
* رفع مشکل نمایش نقشه در برخی صفحات
* حذف نوع مرسوله غیراستاندارد
= 4.2.4 =
...
* Improve: Map feature design pattern
= 4.2.2 =
...
* Tapin: Implement new cities list
* Refactor: Improve update notice performance
= 4.2.0 =
...
== Upgrade Notice ==
= 4.3.0 =
* پس از بروزرسانی یکبار تنظیمات روش‌های حمل و نقل و فرآیند ثبت سفارش را بررسی بفرمایید.
= 4.0.0 =
